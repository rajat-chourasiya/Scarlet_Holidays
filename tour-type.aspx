<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tour-type.aspx.cs" Inherits="tour_type" %>
...
<title>Scarlet Holidays | Tour Type List</title>
                ...
                <div class="content-box">
                    ...
                    <ul class="brdcm-inst">
                       ...
                       <%-- <li><a href="#">Domestic <i class="fa fa-angle-right"></i></a></li>--%>
                        <li><a href="#" id="lable" runat="server"></a></li>
                    </ul>
                </div>
            </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="col-lg-9 col-md-12 col-sm-12 content-side">
                        <div class="tour-list-content">
                            ...
                            <div class="row clearfix">
                                <asp:Repeater ID="tourtype_txt" runat="server">
                                    <ItemTemplate>
                    ...
                    <div class="col-lg-3 col-md-12 col-sm-12 sidebar-side">
                        <div class="tour-sidebar">
                            ...
                            <div class="sidebar-widget category-widget pb_5">
                                ...
                                <div class="cswidget-content">
                                    <ul>
                                         <asp:Repeater ID="tt_txt" runat="server">
                                            <ItemTemplate>
                        ...
                        <div class="tour-sidebar-two">
                                ...
                                <div method="post" action="tour-details.html">
